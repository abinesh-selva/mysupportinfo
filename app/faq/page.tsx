    ...
    return (
        <div className="max-w-[1200px] mx-auto px-6 py-16 w-full">
            ...
            <div className="text-center mb-16">
                <h1 className="text-4xl md:text-5xl font-black mb-4 tracking-tight text-[#00473E]">Frequently Asked Questions</h1>
                <p className="text-[#00473E]/70 text-lg max-w-2xl mx-auto leading-relaxed font-medium">
            ...
            {/* Footer Section CTA */}
            <div className="max-w-[800px] mx-auto mt-20 pt-10 border-t-2 border-[#00473E]/10 text-center">
                <h4 className="text-[#FF8E60] font-black text-sm uppercase tracking-widest mb-4">Still have questions?</h4>
                <p className="text-[#00473E]/70 mb-8 max-w-sm mx-auto font-medium">
